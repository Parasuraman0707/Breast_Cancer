...
#
# st.title("Decision Tree Classifier for Breast Cancer Prediction")
#
# # Upload training dataset
# st.header("Upload Training Dataset")
# train_file = st.file_uploader("Upload your breast-cancer.csv", type=["csv"])
#
...
#         st.error("Dataset must have a 'target' column.")
#     else:
#         # Split data
...
#         st.success(f"Model trained! Accuracy on test split: {accuracy:.2f}")
#
...
#             # print("Model was trained with:", DT.feature_names_in_)
#             # print("New data has:", X_new.columns.tolist())
#             #
#             # # Rename columns to match the model’s training feature names
#             # X_new.columns = DT.feature_names_in_
